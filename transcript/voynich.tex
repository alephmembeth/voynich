...
In total, I made changes in $284$ places of Takahashi's transliteration.
...
\begin{locator}[P1, 1]\end{locator} {\eva okchop chol Shotol oteol okeey s chor d aiin d}\\
\begin{locator}[P1, 2]\end{locator} {\eva choiin Shey keo Sho oiin s chol ldy okeaiin okom}\\
\begin{locator}[P1, 3]\end{locator} {\eva qokeey keor daiin okey keey daiin dair daiin s}\\
\begin{locator}[P1, 4]\end{locator} {\eva okeey d\textcolor{orange}{$\smile$}aiin qokeey chot\textcolor{orange}{o}y tody oky aiiin d}\\
\begin{locator}[P1, 5]\end{locator} {\eva qoty daiin chol oteeol dody cheod chody}\\
\begin{locator}[P1, 6]\end{locator} {\eva Sho keeey key tey daiin daiiin dain dain}\\
\begin{locator}[P1, 7]\end{locator} {\eva daiin qol chy dain * or daiin dai\textcolor{orange}{n} daldy}\\
...
\vspace{1em}
\noindent\begin{locator}[P2, 7]\end{locator} {\eva pardy Shedy qokar Sheedy oraly olaiir okar ar}\\
\begin{locator}[P2, 8]\end{locator} {\eva oekar aiin olkaiin olky dar ald Shek chek qokchy dar ain}\\
\begin{locator}[P2, 9]\end{locator} {\eva tar aiin dal ar ain cheor ydam Shody okal Shdy kShy or}\\
\begin{locator}[P2, 10]\end{locator} {\eva dar ar ykar or yky chdy fchor qokain ar Sheedy olchef}\\
\begin{locator}[P2, 11]\end{locator} {\eva sarol chedy Shekam qokar chl ykeedy chcKhy dalor dy}\\
\begin{locator}[P2, 12]\end{locator} {\eva paiin alaiin otal chd okar am okar cheodal ocKhy}\\
\begin{locator}[P2, 13]\end{locator} {\eva dain o\textcolor{orange}{I}Khedy otedy okedy lchdy okaiin daiiiny}\\
...
\begin{locator}[P1, 1]\end{locator} {\eva pchey keodar aldydy qoky okal Shdy olkedy opches ar ordaiin}\\
\begin{locator}[P1, 2]\end{locator} {\eva qokar okar okedy dar ykchey kaiin okos chedy okar aralos}\\
\begin{locator}[P1, 3]\end{locator} {\eva Shy qokal chdy chcKhd otor aiis oky okolchy qokar okam}\\
\begin{locator}[P1, 4]\end{locator} {\eva or aiin chekody das qokol okaiin okar oky okoldy ol}\\
\begin{locator}[P1, 5]\end{locator} {\eva lokar qokar okar okol ol chedy qokchd ar ar or dam}\\
\begin{locator}[P1, 6]\end{locator} {\eva tor or ar Shokor om olShedy qokam chdy kar oraiin}\\
\begin{locator}[P1, 7]\end{locator} {\eva yaiin chekaiin oky ycheey}\\

\vspace{1em}
\noindent\begin{locator}[P2, 8]\end{locator} {\eva kSheo k\textcolor{orange}{ch}ey dar aim kcheo cFhdy orain chefal daiin dm}\\
\begin{locator}[P2, 9]\end{locator} {\eva taiin ol olaiin or dain okaiin okaiin okaiin daram}\\
\begin{locator}[P2, 10]\end{locator} {\eva saiin olcheey chdy ychey karar oky ykedy okair ody}\\
...
\vspace{1em}
\noindent\begin{locator}[P2, 13]\end{locator} {\eva toees chedy kedy olfchedy qokedy daiin chefain}\\
\begin{locator}[P2, 14]\end{locator} {\eva saiin o lchey kchedy okar qokchdy dy qokees am chdy}\\
\begin{locator}[P2, 15]\end{locator} {\eva qokchey qody or aiiin okaiin o cKhy Sheod fai\textcolor{orange}{d}y}\\
\begin{locator}[P2, 16]\end{locator} {\eva Shol kedy lor ar okar qoky kedy r yteey qoka\textcolor{orange}{$\cancel{x}$}m}\\
\begin{locator}[P2, 17]\end{locator} {\eva tochey qokeedy qokaiin okeor qokar okees ar oky}\\
\begin{locator}[P2, 18]\end{locator} {\eva saiin otain chcKhy okal okair arol qokey okary}\\
...
\begin{locator}[P1, 1]\end{locator} {\eva p\textcolor{orange}{S}hey kedaleey oked Shek\textcolor{orange}{ech}y opShes ypchd qotche\textcolor{orange}{$\cancel{x}$}dy Shkakeedy}\\
\begin{locator}[P1, 2]\end{locator} {\eva ykeeo alShey \textcolor{orange}{o}kedy keShdy dy dor y\textcolor{orange}{ech}oky qokeed chpy qokedy dy}\\
\begin{locator}[P1, 3]\end{locator} {\eva qok ra\textcolor{orange}{y} y\textcolor{orange}{o}kedy ychdy\textcolor{orange}{$\frown$}kchdy qokedy qokedy Shekchy cheky daly}\\
\begin{locator}[P1, 4]\end{locator} {\eva chdchy ytcheeky ypchedy schdy ytedy cTh\textcolor{orange}{h}y chees oteey otal dam}\\
\begin{locator}[P1, 5]\end{locator} {\eva qotchy sal yteedy kchdy dchedy \textcolor{orange}{k}chdy dchedy dalain}\\

\vspace{1em}
\noindent\begin{locator}[P2, 6]\end{locator} {\eva Shedey polchedy qokeey chekedy ytey chkchod ypchedpy Shepy Shedy}\\
\begin{locator}[P2, 7]\end{locator} {\eva parchdy kchey yteedy qokeody ykedy chkedy qokedy chedy qokedy}\\
\begin{locator}[P2, 8]\end{locator} {\eva dair chedy chcKhy qokey lchdy qokedy qok\textcolor{orange}{a}l cheked\textcolor{orange}{y} qodor am}\\
\begin{locator}[P2, 9]\end{locator} {\eva qokeedy okedy chekedy chedy chcKheody chekal daiin cheo al okedy}\\
\begin{locator}[P2, 10]\end{locator} {\eva s\textcolor{orange}{$\frown$}Shok Shedy q\textcolor{orange}{o}kchdy dchdaldy ykedy qokeedy qokedy qoke\textcolor{orange}{d}}\\
