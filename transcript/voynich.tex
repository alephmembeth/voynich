...
In Section \ref{sec:transcription} of this document, mainly to promote easier readability and comparability, a transcription of \textit{Beinecke MS 408} is currently being developed, based on a transliteration by \citet{takahashi_voynich_2004}.\footnote{When starting this project, Takahashi's transliteration was obtained in an automatically capitalized version of the \textit{European} or \textit{Extensible Voynich Alphabet} (EVA) using the \textit{Interlinear Transcription Archive Extractor} by \citet{schwerdtfeger_voynich_2004}. Schwerdtfeger built on an online archive of Voynich transcriptions maintained by Jorge \citet{stolfi_voynich_1998}. When Schwerdtfeger's website went offline, I switched to use the version Takahashi published on his website. Note that this version incorporates updates that are not present in the \textit{Interlinear} version. For a general overview of transcription efforts, see \citet{zandbergen_text_2023}.}
...
\begin{locator}[P1, 1]\end{locator} {\eva 
