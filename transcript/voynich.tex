...
Based on a transliteration by Takahashi (see Section \ref{sec:introduction}), a first basic analysis of glyph frequencies can be performed, counting each letter of the transliteration.
...
It seems straightforward, though, to assume that {\eva c} and {\eva h} are meant to be one glyph, i.e. {\eva ch}.
Likewise, {\eva S} and {\eva h} could be interpreted as another glyph, i.e. {\eva Sh}.
Additionally, one \textit{might} interpret instances of {\eva cTh}, {\eva cKh}, {\eva cPh}, or {\eva cFh} as representing {\eva ch}, on the one hand, and {\eva t}, {\eva k}, {\eva p}, or {\eva f}, on the other.
The two appearances of {\eva z} might also be interpreted as instances of {\eva k}.
This would result in a slightly modified count, as shown in...
