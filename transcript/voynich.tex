...
\begin{locator}[P1, 1]\end{locator} {\eva Shor cThy qoky qokol qokaiin chol chol ykaiin dar om}\\
\begin{locator}[P1, 1]\end{locator} {\eva qo chcThy kchol daiin qoaiin cThy chaiin ykeey cThom}\\
\begin{locator}[P1, 1]\end{locator} {\eva lory kaiin ykeol ykeol cham}\\

\vspace{1em}
\noindent\begin{locator}[P1, 1]\end{locator} {\eva kol!Sho pchor kchey ty opchaldy otShy qokchy dol!daiin}\\
\begin{locator}[P1, 1]\end{locator} {\eva otchar okchar daiin ytchody tcholol otar dal dary}\\
\begin{locator}[P1, 1]\end{locator} {\eva lchar qor y kar dar}\\

\vspace{1em}
\noindent\begin{locator}[P1, 1]\end{locator} {\eva tchol cThy qodaiin cThy dai!n cThey oty!dal daiin m}\\
\begin{locator}[P1, 1]\end{locator} {\eva dor or chain dai!n ykolody ytaiin qotchol kol dy}\\
\begin{locator}[P1, 1]\end{locator} {\eva okaiin Shar yky oky kair daldy dalor cheol dal}\\
\begin{locator}[P1, 1]\end{locator} {\eva l okaiin okcho lalda!!n daldaiin}\\
