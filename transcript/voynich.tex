...
\begin{locator}[P1, 1]\end{locator} {\eva poShody qokodar seodaiin qotal} --- {\eva dscheey saiin!dy}\\
\begin{locator}[P1, 2]\end{locator} {\eva dShody cKhody qokol dy!kaiin chy} --- {\eva qokey daiin cThy}\\
...
\begin{locator}[P1, 8]\end{locator} {\eva olkeeody qokal qodaiin ykhor yfal}\\
\begin{locator}[P1, 9]\end{locator} {\eva daiin cKh!ol Shain tcholol}\\
...
\begin{locator}[P1, 13]\end{locator} {\eva daiin cheol cheodai!n}\\
...
\begin{locator}[P1, 1]\end{locator} {\eva tdokchcFhy ycPhko ytair Shar qofy!daiin ypchy otchol das yty}\\
\begin{locator}[P1, 2]\end{locator} {\eva oty Shor ytol!dy qoky koldal oteees dal s} --- {\eva otar dl}\\
\begin{locator}[P1, 3]\end{locator} {\eva tchot!Shey qoty okchol tchody qotam oky} --- {\eva ytoldy}\\
\begin{locator}[P1, 4]\end{locator} {\eva l Shopchy qoky qotchy oty dar oty dam} --- {\eva ychcThod}\\
...
\begin{locator}[P1, 7]\end{locator} {\eva qokShy qocKhom dals Shodai!m t!!chom dody} --- {\eva ykeey daim am}\\
...
\begin{locator}[P1, 1]\end{locator} {\eva pchor chcPhol cPhaii!n otcheor ytor ko!l chocPhor}\\
\begin{locator}[P1, 2]\end{locator} {\eva ytchey chol cTho!daiis Shy kor esechor chy dam}\\
...
\vspace{1em}
\noindent\begin{locator}[P2, 7]\end{locator} {\eva pcheol Sholoiin cTho!r aiin}\\
\begin{locator}[P2, 8]\end{locator} {\eva kodaiin cThy qokeey s ol}\\
\begin{locator}[P2, 9]\end{locator} {\eva daiin cKheol chol qokeyl daiin}\\
\begin{locator}[P2, 10]\end{locator} {\eva yokeey qokody chol sol!s aiin}\\
...
\begin{locator}[P2, 13]\end{locator} {\eva ykor okaii!n cKheeey daiim}\\
