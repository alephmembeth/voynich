...
In total, I made changes in 228 places of Takahashi's transliteration.
...
\begin{locator}[P1, 1]\end{locator} {\eva kchdy dam dy oky otal dain chdy ytam otam cham}\\
\begin{locator}[P1, 1]\end{locator} {\eva dar chcKhy dy dyky cKhdy oky dam okardy komdy}\\
\begin{locator}[P1, 1]\end{locator} {\eva tokar Shdy dal qok\textcolor{orange}{a}r Shd otody chedy ykedy dodl dain}\\
\begin{locator}[P1, 1]\end{locator} {\eva tchdy chody okaiin chcKhy dor arl cThy dy ty dy ykar cheky dy}\\
\begin{locator}[P1, 1]\end{locator} {\eva ycheo dor olaiin okar chdy chdy oldy okar chdy}\\

\begin{locator}[P1, 1]\end{locator} {\eva tShdy Shefchdy ShcKhdy oltedy daiin oky cheol orain chdyShdy porar}\\
\begin{locator}[P1, 1]\end{locator} {\eva darar Sheey keedy okchy okar okedy chy daiin dy dy dar aiin okary}\\
\begin{locator}[P1, 1]\end{locator} {\eva sar or aiin chor or Shkair Shol or chcKhy ar aiin okain dal dy}\\
\begin{locator}[P1, 1]\end{locator} {\eva lchoar or chey lodaiin oor okeedy okaly}\\
\begin{locator}[P1, 1]\end{locator} {\eva tar al keey oram}\\
