...
In total, I made changes in $388$ places of Takahashi's transliteration.
...
\begin{locator}[P1, 3]\end{locator} {\eva Shol char oteol dor otchol chkchy} --- {\eva daiin}\\
...
\begin{locator}[P2, 9]\end{locator} {\eva qotcheea chety chol chol dai!n}\\
\begin{locator}[P2, 10]\end{locator} {\eva chotcho l!tchey o tcho tchy dy} --- {\eva chol chody dar}\\
\begin{locator}[P2, 11]\end{locator} {\eva oteey cho chdy chy key chyky} --- {\eva dchy daiin chy}\\
\begin{locator}[P2, 12]\end{locator} {\eva cho cho keesy chy chy cheky} --- {\eva chochy daiin}\\
\begin{locator}[P2, 13]\end{locator} {\eva dShy daiin chdlcty chaiin} --- {\eva dcheey otal!d}\\
\begin{locator}[P2, 14]\end{locator} {\eva chol ctche!y}\\
