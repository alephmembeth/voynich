...
Accordingly, Table \ref{tab:count_c} gives frequencies for the {\eva c} combinations, taking into account the four forms of ``pedestalled gallows''.
...
\begin{tabular}{lr}
   ...
   \hline
\end{tabular}
\caption{Glyph frequencies in Takahashi's transliteration for {\eva i} combinations.}
\label{tab:count_i}
\end{table}

This said, I tentatively stipulate a set of 20 glyphs that are most common (i.e., appear more than 1,000 times) in the manuscript...
...
\begin{tabular}{lr}
   ...
   \hline
\end{tabular}
\caption{Glyph frequencies in Takahashi's transliteration for the 20 most common glyphs}
