...
Note that places where the writing is interrupted by illustrations are marked by em dashes (---).
...
\begin{locator}[P1, 1]\end{locator} {\eva pcheodchy dShedy fchedy los aiin ykeeedy Shey ypchedy tchdy chdy ypair y}\\ \hspace*{1em}{\eva chedyty}\\
\begin{locator}[P1, 2]\end{locator} {\eva chey tedy otchody ytchdy otar y!otedy cThdy} --- {\eva okain chety cho!olkeey}\\
\begin{locator}[P1, 3]\end{locator} {\eva alchey kor y keody olkchey chody chedy daly} --- {\eva okeeor aiin otar air am}\\
\begin{locator}[P1, 4]\end{locator} {\eva dchedy tchddy otSh okeey ty otar alchdy} --- {\eva yteedy oteed y tedy m}\\
\begin{locator}[P1, 5]\end{locator} {\eva lkeey qo!cThedy taiin Shed qokar otedy dy} --- {\eva dain tolkain otam}\\
\begin{locator}[P1, 6]\end{locator} {\eva Shdy qokain okar otar or otees ol or ain} --- {\eva otal ok ytar chedy am}\\

\vspace{1em}
\noindent\begin{locator}[P2, 7]\end{locator} {\eva pchedar chey} --- {\eva ypchedy otedy Shefeeedy al} --- {\eva Shedy otedy fcheodal cPhheg}\\
...
\begin{locator}[P2, 10]\end{locator} {\eva tol chedy ytedy} --- {\eva ykeol chdy chdor chtol chdy} --- {\eva ytchedal cThey okar ar ar!y}\\
...
\begin{locator}[P1, 1]\end{locator} {\eva po!Shol dy Shor Shol Shtchy Shor!pchor opchor Shor!kchy}\\
\begin{locator}[P1, 2]\end{locator} {\eva qotor Sho chotchy choShy qopchor qo dor daiin}\\
\begin{locator}[P1, 3]\end{locator} {\eva dSho} --- {\eva dchor dchor daiin dor cheo raiin}\\
...
\begin{locator}[P2, 6]\end{locator} {\eva olor ShShes Sh!eoty chol daiin}\\
...
\begin{locator}[P2, 10]\end{locator} {\eva Sho r choiin Shor Shor Shy}\\
...
\begin{locator}[P3, 13]\end{locator} {\eva sod chol y tcheol daiin cThodd}\\
\begin{locator}[P3, 14]\end{locator} {\eva qo Shoqoky Shor Sheor otol daiin}\\
\begin{locator}[P3, 15]\end{locator} {\eva ochol chol chody dchodaiin daiin}\\
\begin{locator}[P3, 16]\end{locator} {\eva qocho cheey dchey qotchody}\\
\begin{locator}[P3, 17]\end{locator} {\eva olol ol!chey chey kchy qotchol chosory}\\
\begin{locator}[P3, 18]\end{locator} {\eva Sheor cheol od cho dcheeey qotcho!tchy}\\
\begin{locator}[P3, 19]\end{locator} {\eva dcheo r cheey keol!chey chokchol chokan}\\
\begin{locator}[P3, 20]\end{locator} {\eva qotcho chodr cho choShy chs oriin}\\
