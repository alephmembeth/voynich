...
In total, I made changes in $254$ places of Takahashi's transliteration.
...
\begin{locator}[P1, 1]\end{locator} {\eva choiin Shey keo Sho oiin s chol ldy okeaiin okom}\\
\begin{locator}[P1, 1]\end{locator} {\eva qokeey keor daiin okey keey daiin dair daiin s}\\
\begin{locator}[P1, 1]\end{locator} {\eva okeey d\textcolor{orange}{$\smile$}aiin qokeey chot\textcolor{orange}{o}y tody oky aiiin d}\\
\begin{locator}[P1, 1]\end{locator} {\eva qoty daiin chol oteeol dody cheod chody}\\
\begin{locator}[P1, 1]\end{locator} {\eva Sho keeey key tey daiin daiiin dain dain}\\
\begin{locator}[P1, 1]\end{locator} {\eva daiin qol chy dain * or daiin dai\textcolor{orange}{n} daldy}\\
\begin{locator}[P1, 1]\end{locator} {\eva o aiin char chShol chokaiin}\\
