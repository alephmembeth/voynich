...
\begin{locator}01; Paragraph 1\end{locator} {\eva tchedy chepchy daiidy Shol kcheoly choteol Sholschey Shodaiin chetShedy}\\ \hspace*{1em}{\eva otSho qooto\textcolor{orange}{$\frown$}seeey}\\
\begin{locator}02\end{locator} {\eva s\textcolor{orange}{Sh}eykcheol Shchy qety Sheey otchol chal\textcolor{orange}{$\frown$}Sheey daiin Sheody qokol aiir chor}\\ \hspace*{1em}{\eva cheoty oty}\\
\begin{locator}03\end{locator} {\eva Sho chokar sor chor cheky daiin da\textcolor{orange}{r}aii\textcolor{orange}{i}n} --- {\eva ytey tol cheeetchol sam}\\
\begin{locator}04\end{locator} {\eva dcheey qocKhhy chydy}\\

\vspace{1em}
\noindent\begin{locator}05; Ring 1\end{locator} {\eva oko otol ees choty cheda\textcolor{orange}{r} otchdy s\textcolor{orange}{a}r oekaiin oteol dar che\textcolor{orange}{y} dais qoeeokaiin}\\ \hspace*{1em}{\eva otchey dal cheky ykes qoke\textcolor{orange}{g} sol oy ykeoees yty dy dy chody otololees oty}\\ \hspace*{1em}{\eva \textcolor{orange}{d}ar qoteey otey chey kodar dar Sheody Shees daiin oteeoaly oteeosol ol okol}\\ \hspace*{1em}{\eva ol\textcolor{orange}{Sh}y tol cheol okeey choekchchy okchy qokchShy dchol chShek}\\
...
\begin{locator}[18\end{locator} {\eva solaiin cKhhy olekeey dy}\\
\begin{locator}[19\end{locator} {\eva ykeol cTheepchy dar}\\
...
\begin{locator}02\end{locator} {\eva dchaiin Shey dcheedy qokeey Shekeey dal dy Sheet!ey daldy}\\
\begin{locator}03\end{locator} {\eva qoeeey Shekeey Shkeey s alchey cThy Shteody qoteeody dam}\\
\begin{locator}04\end{locator} {\eva okeey Sheoy keol ycheety okeody Shey qokey chol chekody}\\
\begin{locator}05\end{locator} {\eva scheos seekey okey chody} --- {\eva okeos cheo salar oalchdm}\\
...
\begin{locator}02\end{locator} {\eva daiin Shey okaiin Shkechy Sheey tey chy cThy otol cham}\\
\begin{locator}03\end{locator} {\eva Sheos!aiin ct!!!!ar choetey okal chy ykar ytchey cheotam}\\
\begin{locator}04\end{locator} {\eva y!cheo r!aiin ychey otaiin okchor yty chkal Shol}\\
...
\begin{locator}37; Line 17\end{locator} {\eva ykeeos al dair dar}\\

\clearpage
\noindent\begin{locator}38; Line 18\end{locator} {\eva ykeey dal oky}\\
...
%%%%%%%%
\clearpage
\subsection*{Folio 70, Recto 1}
\begin{locator}01; Ring 1\end{locator} {\eva oooooooool!ar !s**r*}\\
\begin{locator}02; Ring 2\end{locator} {\eva okchedy oteos okes okeos cy okchol s!air ody o chopcheopchy chol air Shekchy\\ \hspace*{1em}{\eva choteo!dy oteeShs opcheody otol choky chody chotey Sheal ar ykeody oteey\\ \hspace*{1em}{\eva chedaiin chotar soly-oteody choekeeos alair!dy okol okeey dar!y otor!Sheod}\\
\begin{locator}03; Ring 3\end{locator} {\eva okeol choly yky okchedy chkal ofchor qokal opolaiin okeos oty dal choekeey\\ \hspace*{1em}{\eva dal choekeey dal cheo al otchoky chety chodalar okal chear aly oteos ar os al\\ \hspace*{1em}{\eva oko!l!air dy-oteodas chy oteody tochody okchody ytar ytory}\\

\vspace{1em}
\noindent\begin{locator}04; Line 1\end{locator} {\eva otcho dar yky}\\
\begin{locator}05; Line 2\end{locator} {\eva opar ykchy}\\
\begin{locator}06; Line 3\end{locator} {\eva y saimchy dam}\\
\begin{locator}07; Line 4\end{locator} {\eva otair orolgy}\\
\begin{locator}08; Line 5\end{locator} {\eva dchal da!m}\\
\begin{locator}09; Line 6\end{locator} {\eva yteody sam}\\
\begin{locator}10; Line 7\end{locator} {\eva okchy dal dy}\\
\begin{locator}11; Line 8\end{locator} {\eva yfcheodly}\\
\begin{locator}12; Line 9\end{locator} {\eva ytcheas aly}\\

\vspace{1em}
\noindent\begin{locator}13; Ring 4\end{locator} {\eva otechg tShey ol oteey ched ar oteos Sheor al!al otar ar!y oteod!Shey keody\\ \hspace*{1em}{\eva oteos al}\\

\vspace{1em}
\noindent\begin{locator}14; Label 1\end{locator} {\eva okeody}\\
\begin{locator}15; Label 2\end{locator} {\eva otody}\\
\begin{locator}16; Label 3\end{locator} {\eva ypolol}\\
\begin{locator}17; Label 4\end{locator} {\eva chodal}\\
\begin{locator}18; Label 5\end{locator} {\eva okosd}\\
\begin{locator}19; Label 6\end{locator} {\eva ykeal}\\
...
%%%%%%%%
\clearpage
\subsection*{Folio 70, Recto 2}
\begin{locator}01; Ring 1\end{locator} {\eva sal air am Shed!!!y chokal choIKhy Sho!keey choky chol dy okeeal o!teedy dg!s\\ \hspace*{1em}{\eva dair aiin okees okeear okeear ar alekeey ar kam oteeodalsy chekeoar chokey\\ \hspace*{1em}{\eva dar dcheoky otar doIThy dair otchetchar !!!okseo l!al kchm okar ar dar}\\
\begin{locator}02; Ring 2\end{locator} {\eva otar ar chedal oar al aldaiin ykeeeedaiir Sheo!l dar chal ykees aiis dl cheey\\ \hspace*{1em}{\eva r!keeo d oteeodar aiin aral daiir Sheedal Sheodaiin choar char choteoly cho\\ \hspace*{1em}{\eva oteey chotey csoeky chedy choteos a!m oteodar ocKhh}\\
\begin{locator}03; Ring 3\end{locator} {\eva oches air chess cTheey Sheeody Shopcho yteody ykaldy oteeo!s aiin Shey Shee\\ \hspace*{1em}{\eva fora!r aim cheoteeodal Sho choetchaldy dal aiir ches otes ar dalol chtam -\\ \hspace*{1em}{\eva opaiir chekeo oteedy o!teeo okol chotal otol al dl}\\
\begin{locator}04; Ring 4\end{locator} {\eva otoy ar arodchedy cheecPheey oteeos ees cheol Sheeey okeedaly cheeoekey ykeed*\\ \hspace*{1em}{\eva r!!! oteey s al! s air oteody !!!dar aiir ody cheeos! chey daiin otoeeseor\\ \hspace*{1em}{\eva air chedy oko dar al Sho chotol d!!!al dy}\\
\begin{locator}05; Ring 5\end{locator} {\eva otchsy ol Shy oteo sal ol keey oteol choky otch!o!Shy}\\

\vspace{1em}
\noindent\begin{locator}06; Paragraph 1\end{locator} {\eva otchey Sheol chkey Shep al r ar chly Sheteal aram}\\
\begin{locator}07\end{locator} {\eva dair cheey s ch!otey dShy dam chchet!al ykem!y}\\
\begin{locator}08\end{locator} {\eva ykeeo y s al!! She!y cThy Shekey qokal aiir oteom}\\
\begin{locator}09\end{locator} {\eva daiin okeey Shoaiin cKhhey otal ShShy tal dam}\\
\begin{locator}10\end{locator} {\eva tal cheeod dal chcThy qetal ddl ar chal dal}\\
\begin{locator}11\end{locator} {\eva ytar ar!!l y!ol al aloees ytaiir otal dal}\\
\begin{locator}12\end{locator} {\eva daiin daiin She tal qokal chol cKhhy dy}\\
\begin{locator}13\end{locator} {\eva yta!s alal dalam dal cThol opar!am}\\
\begin{locator}14\end{locator} {\eva dy!Shol Shol Shol ShocThhy dalaly}\\
\begin{locator}15\end{locator} {\eva y!okal chol kShody tol cheey okal}\\
\begin{locator}16\end{locator} {\eva daiin chotal qokal chol chotals}\\
\begin{locator}17\end{locator} {\eva qokal Shkal dal Shy qokal chdy}\\
\begin{locator}18\end{locator} {\eva qotal chey key okechy chdy cham}\\
\begin{locator}19\end{locator} {\eva okaiin chcThhy s or ary}\\
