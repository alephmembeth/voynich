...
In total, I made changes in $367$ places of Takahashi's transliteration.
...
\begin{locator}[P1, 1]\end{locator} {\eva korary chko kol chey fSholom Shor ykchy dod opchaiin olald}\\
...
\begin{locator}[P1, 4]\end{locator} {\eva okchy qocKhy dai!n dai!l dair Shy}\\

\vspace{1em}
\noindent\begin{locator}[P2, 5]\end{locator} {\eva qotol choiin okchar dar oty!} --- {\eva Shoto dol py} --- {\eva oty!tam}\\
\begin{locator}[P2, 6]\end{locator} {\eva ss aiin cPhor qokey tod} --- {\eva ytchdy dy} --- {\eva dy cheg}\\
\begin{locator}[P2, 7]\end{locator} {\eva tchtcho kchol dShy oty ol} --- {\eva ytchom}\\

\vspace{1em}
\noindent\begin{locator}[P3, 8]\end{locator} {\eva ykcheor odal Sho dy pchom} --- {\eva otor oaiir}\\
\begin{locator}[P3, 9]\end{locator} {\eva ychor cThy chol qokom sy} --- {\eva sa ykchom}\\
\begin{locator}[P3, 10]\end{locator} {\eva dShor otShy oky tSholol} --- {\eva ytchor d}\\
