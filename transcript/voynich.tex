...
\noindent\begin{locator}[P1]\end{locator} {\eva koaiin cphor qotoy sha ckhol ykoaiin s oly}\\
\noindent\begin{locator}[P2]\end{locator} {\eva daiidy qoteeol okchor okor olytol dol dar}\\
\noindent\begin{locator}[P3]\end{locator} {\eva okom chol shol seees chom cheeykam okai!}\\
\noindent\begin{locator}[P4]\end{locator} {\eva qodar ees eey kcheol okal do r chear een}\\
\noindent\begin{locator}[P5]\end{locator} {\eva yeeear otchal eeor eear ckhy!}\\
\noindent\begin{locator}[P6]\end{locator} {\eva or cheor kor chodaly chom}\\
\noindent\begin{locator}[P7]\end{locator} {\eva tchor otcham chor cfham s!}\\
\noindent\begin{locator}[P8]\end{locator} {\eva ykchy kchom chor chekeol oka}\\
\noindent\begin{locator}[P9]\end{locator} {\eva ytcheear okeol cthodoaly chor cthy}\\
\noindent\begin{locator}[P10]\end{locator} {\eva ochor daiin qokshol daiim chol okary}\\
\noindent\begin{locator}[P11]\end{locator} {\eva sho shockho ckhy tchor chodaiin chom}\\
\noindent\begin{locator}[P12]\end{locator} {\eva osh chodair ytchy tchor kcham s}\\
\noindent\begin{locator}[P13]\end{locator} {\eva shar shkaiin qokchy yty cthal chky}\\
\noindent\begin{locator}[P14]\end{locator} {\eva dain sheam yteam}\\
