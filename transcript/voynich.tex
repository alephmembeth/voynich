...
In total, I made changes in $337$ places of Takahashi's transliteration.
...
\begin{locator}[P1, 1]\end{locator} {\eva tShodpy oracPhy koees ypSholy Shy otol!oaiin}\\
\begin{locator}[P1, 2]\end{locator} {\eva ydSh dyeees yty oky okchey qykchey dchy dy}\\
\begin{locator}[P1, 3]\end{locator} {\eva oair ekokeey kShotol otol daiin otota y!kal}\\
\begin{locator}[P1, 4]\end{locator} {\eva ychor ykchey ykchy chody dam}\\

\vspace{1em}
\noindent\begin{locator}[P2, 5]\end{locator} {\eva toy Shy!Sho qoteey chor cheeky Sheey ytey daiin}\\
\begin{locator}[P2, 6]\end{locator} {\eva dShor ytchol Shy o ocheek!!y qotchy otchy dar}\\
\begin{locator}[P2, 7]\end{locator} {\eva qotSh oyd Shol qotShy oyty chom}\\

\vspace{1em}
\noindent\begin{locator}[P3, 8]\end{locator} {\eva pShy opchey qopchy ofchey r!oiry Shol o!s ykchy}\\
\begin{locator}[P3, 9]\end{locator} {\eva otchol ol dchcKhy qoky qotchy qokchy qoky d}\\
