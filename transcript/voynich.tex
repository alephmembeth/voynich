...
In total, I made changes in $300$ places of Takahashi's transliteration.
...
\begin{locator}[P1, 1]\end{locator} {\eva tcho cto Sheey qocho taiin Shols} --- {\eva chol chor dain}\\
\begin{locator}[P1, 2]\end{locator} {\eva dShe!y tchey y kchey chtchy cPhy dan} --- {\eva dain otol daiin}\\
\begin{locator}[P1, 3]\end{locator} {\eva Sho chotody chotol oky chol chol} --- {\eva dl chcThy otoy}\\
\begin{locator}[P1, 4]\end{locator} {\eva qotchy chkchy sar dy} --- {\eva odaiil} --- {\eva ykchy okol dd}\\
\begin{locator}[P1, 5]\end{locator} {\eva chokeeor chey chetan} --- {\eva s ary} --- {\eva okol chetaiin}\\
\begin{locator}[P1, 6]\end{locator} {\eva okeokear cheo!tchar} --- {\eva sy} --- {\eva saiin cThar dam}\\
\begin{locator}[P1, 7]\end{locator} {\eva chok Sheo!key keeey d} --- {\eva cheke!!!!!!!esShy}\\
\begin{locator}[P1, 8]\end{locator} {\eva sodal saiin}\\

\vspace{1em}
\noindent\begin{locator}[P2, 9]\end{locator} {\eva poSheor Sho char chekchey qokod} --- {\eva Sho cPheo r!chy}\\
\begin{locator}[P2, 10]\end{locator} {\eva schor okchey chy Shol olor cheaiin} --- {\eva ctchy tcheen d}\\
\begin{locator}[P2, 11]\end{locator} {\eva qo aiin qokeey kchol cheal oteol d} --- {\eva Shey teaiin d}\\
...
\begin{locator}[P2, 14]\end{locator} {\eva qoteey chy kchy cThy et!sees choly} --- {\eva sarar ar al}\\
