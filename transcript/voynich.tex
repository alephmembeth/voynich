...
\begin{locator}[P1, 1]\end{locator} {\eva pds!a!iry dalteoShy da ly Sheet or arodl lkeo r!araiin otedy!o poldy}\\
\begin{locator}[P1, 2]\end{locator} {\eva Shedy ocThy otedy chedy dar ches!cKhy okeody oky okaldy kchdy okar}\\
\begin{locator}[P1, 3]\end{locator} {\eva tody teedy qot chocThy chky oky chdy okedy ykaiin chey ody dary}\\
\begin{locator}[P1, 4]\end{locator} {\eva dShey ykeedy chees aiin chy qocThedy chey qokar checKhy okam}\\
\begin{locator}[P1, 5]\end{locator} {\eva qokchedy or alody otedol chcThdy chtey}\\

\vspace{1em}
\noindent\begin{locator}[P2, 6]\end{locator} {\eva tol!kchdy okedy qokedol Shedy okedal Shedy pchdol otey d!!alorai!n}\\
...
\begin{locator}[P2, 9]\end{locator} {\eva yteedy olos aiin ocKhy}\\

\vspace{1em}
\noindent\begin{locator}[P3, 10]\end{locator} {\eva tar chor ar aldar chdy daldar chepy yteedy !!ypchey pchedy yfor}\\
\begin{locator}[P3, 11]\end{locator} {\eva y Sheey or air yteey cheody ar Sheo qody chcKhy chdy choty ShecThy}\\
\begin{locator}[P3, 12]\end{locator} {\eva y Shee kedy dar chey qotedy ekaiin chedy cThey oteol or aiin odain}\\
\begin{locator}[P3, 13]\end{locator} {\eva dShedy tedy cKhedy chekcheey dy keody otedy cheetam okedar am!am}\\
\begin{locator}[P3, 14]\end{locator} {\eva dykeedai!n chedy okeedy chedal olkey cheky choal chedy oteo!r!om}\\
\begin{locator}[P3, 15]\end{locator} {\eva oteod qolkeey kaldy chy darod* qokeey kol dary taros}\\
