...
\begin{locator}[P1, 1]\end{locator} {\eva oees chor chcKhy qoekchar cheas odaii\textcolor{orange}{i}n kchey chor chaiin}\\
\begin{locator}[P1, 1]\end{locator} {\eva qoair cKhy chol oochocKhy chekchoy cKhy okol rychos}\\
\begin{locator}[P1, 1]\end{locator} {\eva y ShcKhy ytchoy sos y\textcolor{orange}{$\frown$}dady dchy dey okody ytody}\\
\begin{locator}[P1, 1]\end{locator} {\eva dair \textcolor{orange}{Sha} chodam dam okor oty doldom}\\

\vspace{1em}
\noindent\begin{locator}[P1, 1]\end{locator} {\eva tchody ShocThol chocThey s}\\
\begin{locator}[P1, 1]\end{locator} {\eva ychos ychol daiin cThol dol}\\
\begin{locator}[P1, 1]\end{locator} {\eva ychor chor okchey qokom}\\
\begin{locator}[P1, 1]\end{locator} {\eva oeeo dal chor cThom s}\\
\begin{locator}[P1, 1]\end{locator} {\eva qokch\textcolor{orange}{od} ychear kchdy}\\
\begin{locator}[P1, 1]\end{locator} {\eva lor char otam cThom dy}\\
\begin{locator}[P1, 1]\end{locator} {\eva ytchos Shy qokam cThy}\\
\begin{locator}[P1, 1]\end{locator} {\eva yodaiin cThy s chor oees or}\\
\begin{locator}[P1, 1]\end{locator} {\eva qokor chol cThol tchalody}\\
\begin{locator}[P1, 1]\end{locator} {\eva chocKhy s os chy sain or}\\
\begin{locator}[P1, 1]\end{locator} {\eva ochy cThar cThar cThy}\\
\begin{locator}[P1, 1]\end{locator} {\eva y chaiir cKhal cThodam dy}\\
\begin{locator}[P1, 1]\end{locator} {\eva ytcho\textcolor{orange}{$\smile$}cThol ches cThor}\\
\begin{locator}[P1, 1]\end{locator} {\eva ocholy kchos chy dor}\\
\begin{locator}[P1, 1]\end{locator} {\eva dchor choldar okol daiin}\\
\begin{locator}[P1, 1]\end{locator} {\eva ycheor chor ocTham}\\
