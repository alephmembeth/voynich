...
In Section \ref{sec:analysis}, some basic analyses are presented. First, in Section \ref{sec:frequency}, glyph frequencies are counted. In Section \ref{sec:entropy}, then, entropy is calculated.
...
Next, we take a look at the manuscript's entropy.
To this end, we utilize the conceptualization of entropy by \citet{shannon_mathematical_1948}.
As shown in (\ref{eq:shannon}), the entropy \textit{H} of a 
