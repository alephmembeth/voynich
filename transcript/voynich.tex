...
When a glyph has been deleted \textit{without replacement}, this is indicated by \textcolor{orange}{$\cancel{x}$}.
...
In total, I made changes in 131 places of Takahashi's transliteration.
...
\begin{locator}[P1, 1]\end{locator} {\eva oeeesoy qokchy chody qotchy qokchy choty tchol daiin}\\
\begin{locator}[P1, 1]\end{locator} {\eva qotol keeees chotchy tcho choty chor qotol daiin dal}\\
\begin{locator}[P1, 1]\end{locator} {\eva Sho chodaiin choty chol daiin daiin chty chtol}\\
\begin{locator}[P1, 1]\end{locator} {\eva oSho deey cTho l Sho cThy daiin dait oky}\\
\begin{locator}[P1, 1]\end{locator} {\eva Sho tSho chotShol chol todaiin daiin}\\
\begin{locator}[P1, 1]\end{locator} {\eva ykcho lchol cholchaiin otchy s Sheaiin}\\
\begin{locator}[P1, 1]\end{locator} {\eva cho l kchochaiin}\\
